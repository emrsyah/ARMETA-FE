...
import { BookMarked, GraduationCap, Pencil, Plus, Trash2 } from "lucide-react";
...
import {
	...
	useLecturers,
	useSubjects,
} from "@/lib/queries/lecturer-subject";
import type { Lecturer, Subject } from "@/lib/schemas/lecturer-subject.schema";
				...
				<CardHeader className="flex flex-row items-center justify-between">
					<div>
						...
						<p className="text-sm text-muted-foreground">
							List semua dosen yang terdaftar di sistem.
						</p>
					</div>
			...
			<AlertDialog open={!!deleteId} onOpenChange={(open: boolean) => !open && setDeleteId(null)}>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Tindakan ini tidak dapat dibatalkan. Ini akan menghapus data dosen secara permanen
							dari server.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
			...
			<AlertDialog open={!!deleteId} onOpenChange={(open: boolean) => !open && setDeleteId(null)}>
				<AlertDialogContent>
					<AlertDialogHeader>
						<AlertDialogTitle>Apakah Anda yakin?</AlertDialogTitle>
						<AlertDialogDescription>
							Tindakan ini tidak dapat dibatalkan. Ini akan menghapus data mata kuliah secara
