			...
			<SidebarContent>
				...
				<SidebarGroup>
					<div className="rounded-lg bg-linear-to-br from-[#123980] to-[#2067E9] px-4 py-4 text-white">
						<div className="flex items-center justify-between mb-3">
							<span
								className="text-[13px] font-semibold leading-[95%] tracking-normal opacity-90"
				...
				<SidebarGroup>
					<div className="px-3 py-2">
						<h4 className="text-[16px] font-bold text-black tracking-wider">Fitur Utama</h4>
					</div>
					<SidebarGroupContent>
				...
				{isAdmin && (
					<SidebarGroup>
						<div className="px-3 py-2 flex items-center gap-2">
							...
							<h4 className="text-[16px] font-bold tracking-wider">Admin</h4>
						</div>
						<SidebarGroupContent>
							<SidebarMenu className="flex flex-col items-center text-[13px] font-medium leading-[95%] tracking-normal text-justify">
